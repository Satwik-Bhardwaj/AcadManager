...
<html>
    <head>
        ...
        <link rel="stylesheet" href="admDesign.css">
    ...
    <body>
        ...
        <?php
            if(isset($_POST['InsertStudent'])){
                ...
                $class12 = $_REQUEST['class12'];
                $ugdeg = $_REQUEST['ugdeg'];
                ...
                <tr>
                    <td>
                        <div class="data-show-block">
                            ...
                            <a href="site.com/regnumber" class="arrow">
                            ...
                            <form  action="" method="post">
                                <div class="user-details">
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input placeholder="Reg. No." type="text" name="regno" required>
                                    </div>

                                    <div class="input-field">
                                        <span class="details">Father's Name</span>
                                        <input placeholder="Full Father's Name" type="text" name="father_name" required>
                                    </div>
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input placeholder="Date of Birth" type="date" name="dob" required>
                                    </div>
                                    ...
                                    <div class="input-field">
                                        <span class="details">Class 10th Grade</span>
                                        <input placeholder="Example: 45% / 7.9CGPA" type="text" name="class10" required>
                                    </div>
        
                                    <div class="input-field">
                                        <span class="details">Class 12th Grade</span>
                                        <input placeholder="Example: 45% / 7.9CGPA" type="text" name="class12" required>
                                    </div>

                                    <div class="input-field">
                                        <span class="details">Latest UG Degree</span>
                                    ...
                                    <div class="selection-field">
                                        ...
                                        <select id="nationality" name="nationality" data-name="nationality" required ms-field="nationality" data-parsley-required-message="Please let us know your nationality." class="select-field w-select">
                                            <option value="">Select one...</option>
                                    ...
                                    <div class="submit-field">
                                        <input type="submit" value="Insert" name="InsertStudent">
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div id="insertStudent" onclick="insertDetails()">
                <span><i class='bx bx-plus'></i></span>
        </div>
        <script src="tableDynamic.js"></script>
    </body>
</html>